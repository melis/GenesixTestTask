  ...
  return (
    <Layout>
      ...
      <p>
        ...
        GET /api/articles/:id (где : id - это идентификатор статьи ) сами данные
        возвращаются в таком виде:
        <br />
        ...
        <br />
        /articles - список статей <br /> /article/:id - статью по id <br /> Сайт
        должен использовать серверный рендер добавлять соответствующие мета
        теги. <br /> Визуальный дизайн на Ваш взгляд без использования Bootstrap
        …. <br />
      ...
      <div>
        ...
        <div>
          ...
          <Link href={"/api/articles"}>
            <a style={{ color: "blue" }}> http://localhost:3000/api/articles</a>
          </Link>
        </div>
        <div>
          Один артиклы JSON
